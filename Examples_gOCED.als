...
one sig Quantity extends QualityType {}
one sig Q100, Q500, Q600 extends QualityValue {}
...
one sig O_Q500, O_Q600 extends QVAS {}
one sig Re_Q500, In1_Q500, In2_Q100 extends Quality {}
...
pred exampleFromWillPaper_normal_gOCED {
    ...
    Re_Q500.instanceOfQT = Quantity
    Re_Q500.qHasQV = Q500
    Re_Q500.inheresIn = Re_1
    ...
    In1_Q500.instanceOfQT = Quantity
    In1_Q500.qHasQV = Q500
    In1_Q500.inheresIn = In_1

    In2_Q100.instanceOfQT = Quantity
    In2_Q100.qHasQV = Q100
    In2_Q100.inheresIn = In_2
    ...
    no e_4.historicallyDependsOn
    --e_4.historicallyDependsOn = e_3
    no e_5.historicallyDependsOn
    --e_5.historicallyDependsOn = e_4
    no e_6.historicallyDependsOn
    ...
    Quality = Re_Q500 + In1_Q500 + In2_Q100
...
//     no InsertPayment_1.endAt
//     no InsertPayment_2.endAt
